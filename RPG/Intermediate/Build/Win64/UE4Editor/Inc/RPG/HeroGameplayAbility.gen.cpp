...
// Cross Module References
	RPG_API UClass* Z_Construct_UClass_UHeroGameplayAbility_NoRegister();
	RPG_API UClass* Z_Construct_UClass_UHeroGameplayAbility();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHeroGameplayAbility_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "GameplayAbility/HeroGameplayAbility.h" },
		{ "ModuleRelativePath", "GameplayAbility/HeroGameplayAbility.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
		{ "ToolTip", "The Hero Gameplay Ability extends from UHeroGameplayAbility and should be used fpr all Gameplay Ability in Hero" },
	};
#endif
	...
	IMPLEMENT_CLASS(UHeroGameplayAbility, 2773708709);
	template<> RPG_API UClass* StaticClass<UHeroGameplayAbility>()
	{
		return UHeroGameplayAbility::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHeroGameplayAbility(Z_Construct_UClass_UHeroGameplayAbility, &UHeroGameplayAbility::StaticClass, TEXT("/Script/RPG"), TEXT("UHeroGameplayAbility"), false, nullptr, nullptr, nullptr);
