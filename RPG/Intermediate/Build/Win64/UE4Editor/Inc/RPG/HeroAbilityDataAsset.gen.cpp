...
// Cross Module References
	RPG_API UScriptStruct* Z_Construct_UScriptStruct_FHeroGameplayAbilityBindInfo();
	...
	RPG_API UClass* Z_Construct_UClass_UHeroAbilityDataAsset();
...
class UScriptStruct* FHeroGameplayAbilityBindInfo::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern RPG_API uint32 Get_Z_Construct_UScriptStruct_FHeroGameplayAbilityBindInfo_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FHeroGameplayAbilityBindInfo, Z_Construct_UPackage__Script_RPG(), TEXT("HeroGameplayAbilityBindInfo"), sizeof(FHeroGameplayAbilityBindInfo), Get_Z_Construct_UScriptStruct_FHeroGameplayAbilityBindInfo_Hash());
	}
	return Singleton;
}
template<> RPG_API UScriptStruct* StaticStruct<FHeroGameplayAbilityBindInfo>()
{
	return FHeroGameplayAbilityBindInfo::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FHeroGameplayAbilityBindInfo(FHeroGameplayAbilityBindInfo::StaticStruct, TEXT("/Script/RPG"), TEXT("HeroGameplayAbilityBindInfo"), false, nullptr, nullptr);
static struct FScriptStruct_RPG_StaticRegisterNativesFHeroGameplayAbilityBindInfo
{
	FScriptStruct_RPG_StaticRegisterNativesFHeroGameplayAbilityBindInfo()
	{
...
} ScriptStruct_RPG_StaticRegisterNativesFHeroGameplayAbilityBindInfo;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHeroAbilityDataAsset_Statics::NewProp_Abilities_MetaData[] = {
		...
		{ "Comment", "//UHeroAbilityDataAsset(const class FObjectInitializer& InitializerObject);\n" },
		{ "ModuleRelativePath", "Data/HeroAbilityDataAsset.h" },
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHeroAbilityDataAsset(Z_Construct_UClass_UHeroAbilityDataAsset, &UHeroAbilityDataAsset::StaticClass, TEXT("/Script/RPG"), TEXT("UHeroAbilityDataAsset"), false, nullptr, nullptr, nullptr);
