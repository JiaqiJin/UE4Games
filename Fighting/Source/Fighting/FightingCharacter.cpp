...
void AFightingCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Attack3", IE_Pressed, this, &AFightingCharacter::Attack3);
	PlayerInputComponent->BindAction("Attack4", IE_Pressed, this, &AFightingCharacter::Attack4);
}
...
void AFightingCharacter::Attack3()
{
	UE_LOG(LogTemp, Warning, TEXT("Attack3"));
}

void AFightingCharacter::Attack4()
{
	UE_LOG(LogTemp, Warning, TEXT("Attack4"));
}

void AFightingCharacter::TakeDamage(float damageValue)
{
...
void AFightingCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// jump on any touch
	Jump();
}

void AFightingCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}
