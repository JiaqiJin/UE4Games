...
// Cross Module References
	ACTIONRPG_API UClass* Z_Construct_UClass_AHeroPlayerState_NoRegister();
	ACTIONRPG_API UClass* Z_Construct_UClass_AHeroPlayerState();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AHeroPlayerState_Statics::NewProp_AttributeSetBase = { "AttributeSetBase", nullptr, (EPropertyFlags)0x0020080000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AHeroPlayerState, AttributeSetBase), Z_Construct_UClass_UPlayerAttributeSet_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AHeroPlayerState_Statics::NewProp_AttributeSetBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AHeroPlayerState_Statics::NewProp_AttributeSetBase_MetaData)) };
	...
	IMPLEMENT_CLASS(AHeroPlayerState, 1309631778);
	template<> ACTIONRPG_API UClass* StaticClass<AHeroPlayerState>()
	{
		return AHeroPlayerState::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AHeroPlayerState(Z_Construct_UClass_AHeroPlayerState, &AHeroPlayerState::StaticClass, TEXT("/Script/ActionRPG"), TEXT("AHeroPlayerState"), false, nullptr, nullptr, nullptr);
